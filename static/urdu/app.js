...
const VOCABULARY_WORD_DATA = {
  "جنون": { pronunciation: "जुनून", meaning: "obsession", example: "اسے شاعری پڑھنے کا جنون ہے۔", exampleMeaning: "He is obsessed with reading poetry." },
  "الفت": { pronunciation: "उल्फ़त", meaning: "affection", example: "ان دونوں دوستوں کے درمیان گہری الفت ہے۔", exampleMeaning: "There is deep affection between the two friends." },
  "وصل": { pronunciation: "वस्ल", meaning: "union", example: "طویل انتظار کے بعد انہیں وصل کی خوشی ملی۔", exampleMeaning: "After a long wait, they experienced the joy of reunion." },
  "ہجر": { pronunciation: "हिज्र", meaning: "separation", example: "ہجر کی رات اس کے لیے بہت طویل تھی۔", exampleMeaning: "The night of separation was very long for him." },
  "فراق": { pronunciation: "फ़िराक़", meaning: "distance", example: "فراق میں محبوب کی یاد اور بھی ستاتی ہے۔", exampleMeaning: "In separation, memories of one's beloved hurt even more." },
  "آشفتہ": { pronunciation: "आशुफ़्ता", meaning: "perplexed; distracted", example: "خبر سن کر اس کا ذہن آشفتہ ہو گیا۔", exampleMeaning: "His mind became troubled after hearing the news." },
  "اخلاص": { pronunciation: "इख़्लास", meaning: "sincerity", example: "اس نے اخلاص سے اپنے دوست کی مدد کی۔", exampleMeaning: "She helped her friend with sincerity." },
  "رخ": { pronunciation: "रुख़", meaning: "face", example: "اس نے شرم سے اپنا رخ دوسری طرف کر لیا۔", exampleMeaning: "She shyly turned her face away." },
  "زلف": { pronunciation: "ज़ुल्फ़", meaning: "locks of hair", example: "ہوا میں اس کی زلفیں لہرا رہی تھیں۔", exampleMeaning: "Her locks of hair were flowing in the breeze." },
  "گیسو": { pronunciation: "गेसू", meaning: "tresses", example: "اس کے گیسو کندھوں تک آ رہے تھے۔", exampleMeaning: "Her tresses reached her shoulders." },
  "تشنہ": { pronunciation: "तश्ना", meaning: "thirsty; desirous", example: "مسافر کئی گھنٹوں کے سفر کے بعد پانی کا تشنہ تھا۔", exampleMeaning: "The traveler was thirsty for water after several hours of travel." },
  "شوخی": { pronunciation: "शोख़ी", meaning: "playfulness", example: "بچے کی شوخی نے سب کو ہنسا دیا۔", exampleMeaning: "The child's playfulness made everyone laugh." },
  "جلوہ": { pronunciation: "जलवा", meaning: "radiant sight", example: "صبح کے وقت پہاڑوں کا جلوہ دیکھنے کے قابل تھا۔", exampleMeaning: "The sight of the mountains at dawn was worth seeing." },
  "تبسم": { pronunciation: "तबस्सुम", meaning: "smile", example: "اس کے تبسم نے اداس ماحول کو بدل دیا۔", exampleMeaning: "Her smile changed the gloomy atmosphere." },
  "دل": { pronunciation: "दिल", meaning: "heart", example: "اچھی خبر سن کر میرا دل خوش ہو گیا۔", exampleMeaning: "My heart became happy after hearing the good news." },
  "بسمل": { pronunciation: "बिस्मिल", meaning: "wounded", example: "شکاری نے بسمل پرندے کو پانی پلایا۔", exampleMeaning: "The hunter gave water to the wounded bird." },
  "دیوانہ": { pronunciation: "दीवाना", meaning: "mad in love", example: "وہ پرانی کتابوں کا دیوانہ ہے۔", exampleMeaning: "He is crazy about old books." },
  "جان": { pronunciation: "जान", meaning: "life; soul", example: "میری جان، اپنا خیال رکھنا۔", exampleMeaning: "My dear, take care of yourself." },
  "بے شمار": { pronunciation: "बेशुमार", meaning: "countless", example: "آسمان پر بے شمار ستارے چمک رہے تھے۔", exampleMeaning: "Countless stars were shining in the sky." },
  "دل فزا": { pronunciation: "दिलफ़ज़ा", meaning: "heart-pleasing", example: "باغ کا دل فزا منظر سب کو پسند آیا۔", exampleMeaning: "Everyone liked the heart-pleasing view of the garden." },
  "حسرت": { pronunciation: "हसरत", meaning: "unfulfilled desire", example: "اسے بیرون ملک پڑھنے کی حسرت رہ گئی۔", exampleMeaning: "She was left with an unfulfilled desire to study abroad." },
  "درد": { pronunciation: "दर्द", meaning: "pain", example: "چوٹ کی وجہ سے اس کے ہاتھ میں درد ہے۔", exampleMeaning: "His hand hurts because of the injury." },
  "آہ": { pronunciation: "आह", meaning: "sigh", example: "بوڑھے شخص نے تھک کر ایک گہری آہ بھری۔", exampleMeaning: "The old man let out a deep sigh after becoming tired." },
  "نالہ": { pronunciation: "नाला", meaning: "lamentation", example: "مظلوم کی نالہ سن کر لوگ جمع ہو گئے۔", exampleMeaning: "People gathered after hearing the victim's lament." },
  "اشک": { pronunciation: "अश्क़", meaning: "tears", example: "خوشی کے اشک اس کی آنکھوں میں آ گئے۔", exampleMeaning: "Tears of joy came to her eyes." },
  ...
  "فلک": { pronunciation: "फ़लक़", meaning: "sky; heavens", example: "رات کو فلک پر چاند صاف دکھائی دے رہا تھا۔", exampleMeaning: "The moon was clearly visible in the sky at night." },
  "آسمان": { pronunciation: "आसमान", meaning: "sky", example: "بارش کے بعد آسمان صاف ہو گیا۔", exampleMeaning: "The sky cleared after the rain." },
  "گل": { pronunciation: "गुल", meaning: "flower", example: "اس نے میز پر ایک سرخ گل رکھا۔", exampleMeaning: "She placed a red flower on the table." },
  "بلبل": { pronunciation: "बुलबुल", meaning: "nightingale", example: "بلبل صبح سویرے باغ میں گانے لگی۔", exampleMeaning: "The nightingale began singing in the garden early in the morning." },
  "صیاد": { pronunciation: "सय्याद", meaning: "fowler; hunter", example: "صیاد نے جال درخت کے نیچے رکھ دیا۔", exampleMeaning: "The fowler placed a net under the tree." },
  "قفس": { pronunciation: "क़फ़स", meaning: "cage", example: "اس نے پنجرے کا دروازہ کھول کر پرندے کو آزاد کر دیا۔", exampleMeaning: "He opened the cage and set the bird free." },
  "بہار": { pronunciation: "बहार", meaning: "spring", example: "بہار آتے ہی باغ میں نئے پھول کھل گئے۔", exampleMeaning: "As spring arrived, new flowers bloomed in the garden." },
  "خزاں": { pronunciation: "ख़िज़ाँ", meaning: "autumn", example: "خزاں میں درختوں کے پتے زرد ہو جاتے ہیں۔", exampleMeaning: "In autumn, the leaves of the trees turn yellow." },
  "چمن": { pronunciation: "चमन", meaning: "garden", example: "بچے شام کو چمن میں کھیلنے گئے۔", exampleMeaning: "The children went to play in the garden in the evening." },
  "شب": { pronunciation: "शब", meaning: "night", example: "شب کے سناٹے میں دور سے اذان کی آواز آئی۔", exampleMeaning: "In the silence of night, the call to prayer came from far away." },
  "سحر": { pronunciation: "सहर", meaning: "dawn", example: "سحر کے وقت ٹھنڈی ہوا چل رہی تھی۔", exampleMeaning: "A cool breeze was blowing at dawn." },
  "ظلمت": { pronunciation: "ज़ुल्मत", meaning: "darkness", example: "چراغ جلتے ہی کمرے کی ظلمت ختم ہو گئی۔", exampleMeaning: "As soon as the lamp was lit, the darkness in the room disappeared." },
  "ماہ": { pronunciation: "माह", meaning: "moon", example: "ماہ کی روشنی جھیل کے پانی پر پڑ رہی تھی۔", exampleMeaning: "The moon's light was falling on the lake's water." },
  "قمر": { pronunciation: "क़मर", meaning: "full moon", example: "قمر بادلوں کے پیچھے چھپ گیا۔", exampleMeaning: "The full moon disappeared behind the clouds." },
  "آفتاب": { pronunciation: "आफ़ताब", meaning: "sun", example: "آفتاب نکلتے ہی دھند کم ہونے لگی۔", exampleMeaning: "As the sun rose, the fog began to clear." },
  "صبح": { pronunciation: "सुबह", meaning: "morning", example: "صبح میں نے کھڑکی کھولی اور تازہ ہوا محسوس کی۔", exampleMeaning: "In the morning, I opened the window and felt the fresh air." },
  "ساقی": { pronunciation: "साक़ी", meaning: "cup-bearer", example: "ساقی نے سب مہمانوں کو پانی پیش کیا۔", exampleMeaning: "The cup-bearer offered water to all the guests." },
  "رند": { pronunciation: "रिंद", meaning: "intoxicated free-thinker", example: "رند نے دنیا کی رسموں کی پروا نہیں کی۔", exampleMeaning: "The free-thinker did not care about the world's conventions." },
  "مے خانہ": { pronunciation: "मयख़ाना", meaning: "tavern", example: "شاعر نے مے خانہ کے بجائے کتابوں کی محفل پسند کی۔", exampleMeaning: "The poet preferred a gathering of books to a tavern." },
  "پیمانہ": { pronunciation: "पैमाना", meaning: "goblet", example: "اس نے پیمانہ میز پر رکھ دیا۔", exampleMeaning: "He placed the goblet on the table." },
  "بادہ": { pronunciation: "बादा", meaning: "wine", example: "شاعر کی غزل میں بادہ اور جام کا ذکر ہے۔", exampleMeaning: "The poet's ghazal mentions wine and the cup." },
  "صراحی": { pronunciation: "सुराही", meaning: "flask", example: "صراحی سے ٹھنڈا پانی گلاس میں ڈالا گیا۔", exampleMeaning: "Cold water was poured from the flask into the glass." },
  "خم": { pronunciation: "ख़ुम", meaning: "wine-jar", example: "قدیم تہہ خانے میں شراب کا ایک بڑا خم رکھا تھا۔", exampleMeaning: "A large wine jar was kept in the old cellar." },
  "منزل": { pronunciation: "मंज़िल", meaning: "destination", example: "مسافر شام سے پہلے اپنی منزل تک پہنچ گیا۔", exampleMeaning: "The traveler reached his destination before evening." },
  "راہ": { pronunciation: "राह", meaning: "path", example: "صحیح راہ چننے کے لیے اس نے استاد سے مشورہ کیا۔", exampleMeaning: "He consulted his teacher to choose the right path." },
  "غبار": { pronunciation: "ग़ुबार", meaning: "dust; cloud", example: "تیز ہوا سے سڑک کا غبار ہر طرف پھیل گیا۔", exampleMeaning: "The dust from the road spread everywhere in the strong wind." },
  "جادہ": { pronunciation: "जादा", meaning: "track", example: "پرانا جادہ پہاڑ کے دامن سے گزرتا ہے۔", exampleMeaning: "The old track passes along the foot of the mountain." },
  "گام": { pronunciation: "गाम", meaning: "stride; step", example: "منزل ابھی دور ہے، مگر ہر گام ہمیں آگے لے جاتا ہے۔", exampleMeaning: "The destination is still far, but every step takes us forward." },
  "راہ نورد": { pronunciation: "राहनवर्द", meaning: "wayfarer", example: "راہ نورد نے رات ایک چھوٹے گاؤں میں گزاری۔", exampleMeaning: "The wayfarer spent the night in a small village." },
  "کارواں": { pronunciation: "कारवाँ", meaning: "caravan", example: "کارواں سورج ڈوبنے سے پہلے اگلے پڑاؤ پر پہنچ گیا۔", exampleMeaning: "The caravan reached the next stop before sunset." },
  "چشم": { pronunciation: "चश्म", meaning: "eye", example: "اس کی چشم میں خوشی صاف نظر آ رہی تھی۔", exampleMeaning: "Joy was clearly visible in her eye." },
  "نظر": { pronunciation: "नज़र", meaning: "gaze", example: "اس نے پہلی نظر میں مسئلہ سمجھ لیا۔", exampleMeaning: "He understood the problem at first glance." },
  "نگاہ": { pronunciation: "निगाह", meaning: "look; sight", example: "ماں کی نگاہ ہمیشہ اپنے بچوں پر رہتی ہے۔", exampleMeaning: "A mother's gaze is always on her children." },
  "دیدہ": { pronunciation: "दीदा", meaning: "eye", example: "اس نے دیدہ و دل سے مہمان کا استقبال کیا۔", exampleMeaning: "He welcomed the guest with all his heart and eyes." },
  "آنکھ": { pronunciation: "आँख", meaning: "eye", example: "آنکھ میں دھول چلی جانے سے اسے تکلیف ہوئی۔", exampleMeaning: "He felt discomfort when dust got into his eye." },
  "ابرو": { pronunciation: "अब्रू", meaning: "eyebrow", example: "اس نے حیرت سے ابرو اٹھائے۔", exampleMeaning: "She raised her eyebrow in surprise." },
  "مژگاں": { pronunciation: "मिज़गाँ", meaning: "eyelashes", example: "اس کی مژگاں پر شبنم کے قطرے ٹھہرے تھے۔", exampleMeaning: "Dewdrops rested on her eyelashes." },
  "حسن": { pronunciation: "हुस्न", meaning: "beauty", example: "قدرت کے حسن نے سب کو حیران کر دیا۔", exampleMeaning: "The beauty of nature amazed everyone." },
  "جمال": { pronunciation: "जमाल", meaning: "elegance", example: "قدیم عمارت کا جمال آج بھی قائم ہے۔", exampleMeaning: "The elegance of the old building still endures." },
  "نور": { pronunciation: "नूर", meaning: "light", example: "سورج کا نور کھڑکی سے کمرے میں داخل ہوا۔", exampleMeaning: "The light of the sun entered the room through the window." },
  "پیکر": { pronunciation: "पैकर", meaning: "figure; form", example: "وہ صبر و حوصلے کا پیکر ہے۔", exampleMeaning: "She is the embodiment of patience and courage." },
  "نزاکت": { pronunciation: "नज़ाकत", meaning: "delicacy", example: "اس پھول کو نزاکت سے ہاتھ میں اٹھاؤ۔", exampleMeaning: "Pick up this flower delicately." },
  "رعنائی": { pronunciation: "रानाई", meaning: "gracefulness", example: "بہار نے وادی کی رعنائی بڑھا دی۔", exampleMeaning: "Spring increased the gracefulness of the valley." },
  "آفتاب رو": { pronunciation: "आफ़ताबरू", meaning: "sun-faced", example: "شاعر نے اپنی محبوبہ کو آفتاب رو کہا۔", exampleMeaning: "The poet called his beloved sun-faced." },
  "وحشت": { pronunciation: "वहशत", meaning: "wildness; dread", example: "سنسان گھر کی خاموشی نے اس کے دل میں وحشت پیدا کی۔", exampleMeaning: "The silence of the deserted house created dread in his heart." },
  "صحرا": { pronunciation: "सहरा", meaning: "desert", example: "مسافر صحرا میں پانی کی تلاش کرتا رہا۔", exampleMeaning: "The traveler kept searching for water in the desert." },
  "آوارہ": { pronunciation: "आवारा", meaning: "wanderer", example: "آوارہ کتے کو ایک خاندان نے گھر دے دیا۔", exampleMeaning: "A family gave a stray dog a home." },
  "بیابان": { pronunciation: "बियाबान", meaning: "wilderness", example: "وہ بیابان راستے سے گزرنے سے گھبرا رہا تھا۔", exampleMeaning: "He was nervous about traveling through the wilderness." },
  "خرابہ": { pronunciation: "ख़राबा", meaning: "ruin", example: "قدیم محل اب ایک خاموش خرابہ بن چکا ہے۔", exampleMeaning: "The ancient palace has now become a silent ruin." },
  "مجنوں": { pronunciation: "मजनूँ", meaning: "madman", example: "عاشق کو لوگ اس کی وفا کی وجہ سے مجنوں کہتے تھے۔", exampleMeaning: "People called the lover mad because of his devotion." },
  "گریباں": { pronunciation: "गिरेबाँ", meaning: "collar", example: "غم سے اس نے اپنا گریباں پکڑ لیا۔", exampleMeaning: "In grief, he clutched his collar." },
  "وفا": { pronunciation: "वफ़ा", meaning: "loyalty", example: "سچی دوستی میں وفا اور اعتماد ضروری ہیں۔", exampleMeaning: "Loyalty and trust are essential in true friendship." },
  "جفا": { pronunciation: "जफ़ा", meaning: "cruelty", example: "اس کی جفا نے پرانے دوست کا دل توڑ دیا۔", exampleMeaning: "His cruelty broke the old friend's heart." },
  "صنم": { pronunciation: "सनम", meaning: "idol; beloved", example: "شاعر نے اپنی صنم کی تعریف میں غزل لکھی۔", exampleMeaning: "The poet wrote a ghazal praising his beloved." },
  "باوفا": { pronunciation: "बावफ़ा", meaning: "faithful", example: "وہ ایک باوفا ساتھی ہے جو مشکل وقت میں ساتھ دیتا ہے۔", exampleMeaning: "He is a faithful companion who stays in difficult times." },
  "حرف": { pronunciation: "हर्फ़", meaning: "blame; letter", example: "اس نے میری بات کا ایک حرف بھی نہیں بھلایا۔", exampleMeaning: "She did not forget a single word of what I said." },
  "پیمان": { pronunciation: "पैमाँ", meaning: "promise", example: "دونوں دوستوں نے ہمیشہ ساتھ رہنے کا پیمان کیا۔", exampleMeaning: "The two friends made a promise to always stay together." },
  "عہد": { pronunciation: "अहद", meaning: "vow", example: "اس نے اپنے عہد کو پورا کرنے کے لیے محنت کی۔", exampleMeaning: "He worked hard to fulfill his vow." },
  "کلام": { pronunciation: "कलाम", meaning: "speech", example: "استاد کا کلام طلبہ کے لیے بہت متاثر کن تھا۔", exampleMeaning: "The teacher's speech was very inspiring for the students." },
  "بیان": { pronunciation: "बयान", meaning: "narration", example: "گواہ نے عدالت میں اپنا بیان ریکارڈ کرایا۔", exampleMeaning: "The witness recorded his statement in court." },
  "خاموشی": { pronunciation: "ख़ामोशी", meaning: "silence", example: "کلاس میں استاد کے آتے ہی خاموشی چھا گئی۔", exampleMeaning: "Silence fell over the class as soon as the teacher arrived." },
  "سکوت": { pronunciation: "सुकूत", meaning: "stillness", example: "رات کے سکوت میں دریا کی آواز سنائی دیتی تھی۔", exampleMeaning: "The sound of the river could be heard in the stillness of night." },
  "آواز": { pronunciation: "आवाज़", meaning: "voice", example: "مجھے باہر سے اپنے بھائی کی آواز سنائی دی۔", exampleMeaning: "I heard my brother's voice from outside." },
  "نغمہ": { pronunciation: "नग़मा", meaning: "melody", example: "پرندوں کا نغمہ صبح کو اور خوب صورت بنا دیتا ہے۔", exampleMeaning: "The birds' melody makes the morning more beautiful." },
  "صدا": { pronunciation: "सदा", meaning: "echo; call", example: "دور پہاڑوں سے گھنٹی کی صدا آ رہی تھی۔", exampleMeaning: "The sound of a bell was coming from the distant mountains." }
};
